...
function checkWin() {
  ...
  if (correct) {
    ...
    let winText = document.createTextNode(
      `Congratulations!You've guessed the word: ${randomValueValue}`
    );
    let reloadBtn = document.createElement("button");
    let reloadBtnText = document.createTextNode(`RELOAD GAME`);
    reloadBtn.appendChild(reloadBtnText);
    winDiv.appendChild(reloadBtn);
    reloadBtn.addEventListener("click", function () {
      window.location.reload();
    });
    winDiv.appendChild(winText);
    winDiv.className = "popupwin";
